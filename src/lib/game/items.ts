...
export const WEAPON_GRIPS: Record<string, WeaponGripTransform> = {
  ...
  axe_2handed: { position: [0, 0.04, 0], rotation: [0, 0, 0], scale: 0.88, inwardAim: 0.1 },
  dagger: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.78, inwardAim: 0.16 },
  sword_1handed: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.78, inwardAim: 0.14 },
  Bow_Wooden: { position: [0, 0, 0.29], rotation: [0, HALF_PI, HALF_PI], scale: 0.28 },
  Axe_Double: { position: [-0.13, -0.05, 0.2], rotation: [0, 0, 0], scale: 0.2, inwardAim: 0.08 },
  Bow_Evil: { position: [0, 0, 0.28], rotation: [0, HALF_PI, HALF_PI], scale: 0.27 },
  Bow_Golden: { position: [0, 0, 0.29], rotation: [0, HALF_PI, HALF_PI], scale: 0.28 },
  axe_1handed: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.82, inwardAim: 0.14 },
  ...
  Claymore: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.25, inwardAim: 0.1 },
  spellbook_open: { position: [0, 0, 0.12], rotation: [0, 0, 0], scale: 0.88 },
  staff: { position: [0, 0, 0.38], rotation: [0, 0, 0], scale: 0.68, inwardAim: 0.08 },
  Skeleton_Axe: { position: [0, 0, 0.08], rotation: [0, 0, 0], scale: 0.8, inwardAim: 0.1 },
  Skeleton_Staff: { position: [0, 0, 0.38], rotation: [0, 0, 0], scale: 0.68, inwardAim: 0.08 },
  sword_2handed_color: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.7, inwardAim: 0.1 },
  wand: { position: [0, 0, 0.04], rotation: [0, 0, 0], scale: 0.92, inwardAim: 0.12 },
  shield_spikes: { position: [0, 0, 0.12], rotation: [0, 0, 0], scale: 0.82 },
  crossbow_2handed: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.82 },
  sword_2handed: { position: [0, 0, 0], rotation: [0, 0, 0], scale: 0.68, inwardAim: 0.1 },
...
export const WEAPON_MODELS: Record<string, WeaponModelDef> = {
  ...
  w_hatchet: { model: "axe_1handed", kind: "blade", tint: 0xb8c8d8 },
