...
- **SMALL-SCREEN FIT (2026-07-12)**: the pre-battle showcase overflowed on non-Max iPhones (5th item clipped) — chips/portrait/headline compacted plus `overflow-y-auto` safety, verified at 375x667. The champion screen's giant floating crown emoji was replaced by a small tilted crown overlaid on the portrait's head.
